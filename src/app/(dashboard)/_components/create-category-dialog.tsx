...
function CreateCategoryDialog({ type, onSuccessCallback, trigger }: CreateCategoryDialogProps) {
    ...
    const onSubmit = useCallback((values: CreateCategoriesSchemaType) => {
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>
                                    Isso é como a sua categoria irá aparecer no aplicativo (requerido)
                                </FormDescription>
                            </FormItem>
                        )}
                    />
